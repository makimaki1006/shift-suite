...
# データ品質評価用定数 (Truth-Driven Analysis System)
QUALITY_PREVIEW_ROWS = 10              # スキーマ推論時の読み込み行数
QUALITY_SCORE_MAX = 100.0              # 最大品質スコア
QUALITY_PARTIAL_EXCEL_SCORE = 50.0     # 非Excel形式の部分スコア
QUALITY_LARGE_FILE_SIZE = 50 * 1024 * 1024  # 50MB - 大容量ファイル閾値
QUALITY_LARGE_FILE_SCORE = 70.0        # 大容量ファイルのスコア
QUALITY_SINGLE_SHEET_SCORE = 80.0      # 単一シートファイルのスコア
QUALITY_STAFF_MISSING_SCORE = 50.0     # staff列欠損時のスコア
