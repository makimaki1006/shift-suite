...
Input  : shortage_role.xlsx  (generated by shortage_and_brief)
Output : hire_plan.xlsx      (role / lack_h / hire_fte / est_monthly_pay / est_recruit_cost)
